...
// // // 每次源码迭代需要打开测试是否缺参
const encrypt_time = 1740301777882;
...
const ms_str = "tk03wa40f1c7018niwUlfE6wTU6GvRxCyVDB61L6E8VhQkcO38bGy7lNVERzpMwLDhO7nb7on3tnvvhm-MolFKKfe1hprsrrrrr3a9pxdc7020250223170937882618e94aCYiZv8IWtpFX";
const ms_words = MJDModule.MD5(ms_str);
const ms = ms_words.toString();
console.log("ms: ", ms);

const gs_str = ms + "appid:tsw-m&body:dc558931e5f4ff2f02aa2f58ace2e7e063cceb42122fa6e8620eaf799c286dba&functionId:getGPOrderDetail&t:1740301639139" + ms;
...
const _wq_dy1_tk_algo = "";
