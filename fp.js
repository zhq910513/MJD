...
var JDHAppBridge,
    ...
    JDBMallAppBridge,
    YJCAppBridge,
    _riskFpMode = _riskFpMode || _0x3f5411(472),
    jdtRiskContext = (_0x3f5411(744) != _riskFpMode && (_riskFpMode = _0x3f5411(472)), _0x3f5411(680) != typeof String[_0x3f5411(892)][_0x3f5411(917)] && (String[_0x3f5411(892)].startsWith = function(e) {
    var t = _0x3f5411;
...
window[_0x3f5411(643)] || (
    window[_0x3f5411(643)] = (o => (o[_0x3f5411(530)] = {},
...
var collectConfig = collectConfig || {
  ...
  , jdtRiskUtil = (a => {
    ...
    a[c(684)] = function(e, t) {
        ...
        try {
            if (e && t) {
                var n, r = jdtLocalStorageManager[i(395)](collectConfig[i(795)][i(901)]), o = {}, a = (r && (o = JSON[i(535)](r)),
                (new Date)[i(779)]());
                for (n in o)
                    o[n] < a && delete o[n];
                o[e] = a + 1e3 * t,
  ...
  , JdtRiskFingerPrint = function(l) {
    ...
    return {
        getFp: function(e) {
            var t, i, n, r, o, a, s = u, c = (p = p || jdtRiskStorageManager[s(657)](collectConfig[s(795)][_riskFpMode][s(621)], !1),
  ...
  , SdkCollector = function(e) {
    var t, i, n, a, s, c = _0x3f5411, l = e[c(573)] || c(760), d = e[c(709)] || 2, u = e[c(782)] || 50, p = e[c(460)] || "42";
    function g(e, o) {
        var a = c;
...
function doCollectFp() {
    ...
    try {
        ...
        var i, n, r, o = new TDEnvCollector(collectConfig[t(688)](_riskFpMode))[t(880)](), a = t(841) == typeof orderId ? orderId : "", s = t(515) != typeof jdfp_pinenp_ext && jdfp_pinenp_ext ? 2 : 1, c = {
