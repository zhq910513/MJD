...
class MJDBase(object):
    ...
    def generate_device_fp(self, device):
        fp_list_str = "envCollect" + device["webgl_3d"].replace("�", "\xa7")
        _fp_list_str = ("envCollect"
                        ...
                        "§w111024"
                        "§w1216384"
                        "§w1316§w1416384§w1530§w1616§w1716§w184096§w19[32767, 32767]§w208§w21WebKit WebGL§w22WebGL GLSL ES 1.0 (OpenGL ES GLSL ES 1.0 Chromium)§w230§w24WebKit§w25WebGL 1.0 (OpenGL ES 2.0 Chromium)§wuv:Google Inc. (Intel)§wur:ANGLE (Intel, Intel(R) UHD Graphics (0x00004626) Direct3D11 vs_5_0 ps_5_0, D3D11)")
        return self.h5st_modules.call("generate_device_fp", fp_list_str)
    ...
    def generate_device(self):
        ...
        device_fp = self.generate_device_fp(device)
    ...
    def refresh_tk_rd(self, expand_params):
