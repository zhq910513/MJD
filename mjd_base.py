...
class MJDBase(object):
    ...
    @staticmethod
    def init_webglFp_modules():
        # 读取本地 JavaScript 文件内容
        with open('webglFp.js', 'r', encoding='utf-8') as file:
            js_code = file.read()
        return execjs.compile(js_code)
    ...
    def generate_webglFp(self, device):
        ...
        return self.webglFp_modules.call("generate_webglFp", r_list)
    ...
    def generate_device(self):
        ...
        self.webglFp = self.generate_webglFp(device)
        extend = {
            "wd": 0,
            "l": 0,
            "ls": 5,
        ...
        expandParams = self.generate_expand_params(device=device, extend=extend)
        print(expandParams)
        ...
        return [
            ({
                 ...
                 "eid_token": "jdd036GW2Z3HU2M3GXJOWMDRZJG5OASMRDUS3MHOPOX6AIX6N7R2PH4MYVOHA2OK2MS3CDPEWHKTDG6K6Q6TR4IX4PVYMNQAAAAMU2VVFHQYAAAAACWSCWRFALI7OGIX",
    ...
    def generate_expand_params(self, device, extend):
        input_expand_params_dict = {
            ...
            "ml": 2,
            "pl": 5,
            "av": "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36",
        ...
        print(input_expand_params_str)
        _input_expand_params_str = '{\n  "wc": 0,\n  "wd": 0,\n  "l": "zh-CN",\n  "ls": "zh-CN,zh,en,ko",\n  "ml": 2,\n  "pl": 5,\n  "av": "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36",\n  "ua": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36",\n  "sua": "Windows NT 10.0; Win64; x64",\n  "pp": {\n    "p1": "zhq91513"\n  },\n  "extend": {\n    "wd": 0,\n    "l": 0,\n    "ls": 5,\n    "wk": 0,\n    "bu1": "0.1.5",\n    "bu2": 0,\n    "bu3": 38,\n    "bu4": 0,\n    "bu5": 0,\n    "bu6": 4,\n    "bu7": 0,\n    "bu8": 0,\n    "bu10": 5\n  },\n  "pp1": "",\n  "bu1": "Error: test err\\n    at HTMLDocument._$hv [as querySelector] (https://storage.360buyimg.com/webcontainer/js_security_v3_0.1.5.js:5:8206)\\n    at https://storage.360buyimg.com/dlxt/recharge/2d8254d/assets/index-0487cad1.js:12099:25\\n    at Array.map (<anonymous>)\\n    at preload (https://storage.360buyimg.com/dlxt/recharge/2d8254d/assets/index-0487cad1.js:12084:27)\\n    at https://storage.360buyimg.com/dlxt/recharge/2d8254d/assets/index-0487cad1.js:12129:45\\n    at T$1 (https://storage.360buyimg.com/dlxt/recharge/2d8254d/assets/index-0487cad1.js:239:10)\\n    at Vk (https://storage.360buyimg.com/dlxt/recharge/2d8254d/assets/index-0487cad1.js:6943:14)\\n    at Uk (https://storage.360buyimg.com/dlxt/recharge/2d8254d/assets/index-0487cad1.js:6599:12)\\n    at Tk (https://storage.360buyimg.com/dlxt/recharge/2d8254d/assets/index-0487cad1.js:6592:5)\\n    at Ik (https://storage.360buyimg.com/dlxt/recharge/2d8254d/assets/index-0487cad1.js:6575:7)",\n  "w": 1536,\n  "h": 864,\n  "ow": 1536,\n  "oh": 816,\n  "url": "https://recharge.m.jd.com/orderDetail?orderId=307843863375&serviceType=3&source=41",\n  "og": "https://recharge.m.jd.com",\n  "pf": "Win32",\n  "pr": 1.25,\n  "re": "",\n  "random": "42cSQ5miD",\n  "referer": "",\n  "v": "h5_file_v5.0.5",\n  "bu2": "    at _$hE._$rgo (https://storage.360buyimg.com/webcontainer/js_security_v3_0.1.5.js:5:77632)",\n  "canvas": "0fb7f119e21bb6b17b2b0d333a5617bf",\n  "canvas1": "0fb7f119e21bb6b17b2b0d333a5617bf",\n  "webglFp": "9ef6901beacde53c5b05944cce35c114",\n  "webglFp1": "9ef6901beacde53c5b05944cce35c114",\n  "ccn": 20,\n  "ai": "73806",\n  "fp": "d9d93apwxrd9rsq5",\n  "wk": -2\n}'
        print(_input_expand_params_str)
        print(input_expand_params_str == _input_expand_params_str)
        return self.h5st_modules.call("generate_extend_params", input_expand_params_str)
    ...
    def generate_tk_rd(self, wq_dy1_tk_algo):
        return self.h5st_modules.call("get_tk_rd", wq_dy1_tk_algo)
...
if __name__ == '__main__':
    ...
    #     ""))
    # device = random.choice(mj.device_list())
    # print(mj.generate_webglFp(device))

    print(mj.generate_expand_params())
